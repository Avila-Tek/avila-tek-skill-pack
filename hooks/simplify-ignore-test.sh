...
# Source the hook script directly to load filter_file and its dependencies
# shellcheck source=hooks/simplify-ignore.sh
source "$(dirname "${BASH_SOURCE[0]}")/simplify-ignore.sh" 2>/dev/null || source hooks/simplify-ignore.sh
