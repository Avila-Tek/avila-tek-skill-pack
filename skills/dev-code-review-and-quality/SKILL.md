...
- **Avila Tek:** If a story file exists (`docs/epics/E-XXX_slug/stories/E-XXX_S-YYY_slug/E-XXX_S-YYY_slug.md`), verify that every Section 2 Acceptance Criterion (AC-01, AC-02, …) is covered by tests and implementation before approving.
...
> "Review passed. When you're ready, run `/ship` to launch (`dev-shipping-and-launch`)."
