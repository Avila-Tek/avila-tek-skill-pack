...
description: >
  Builds production-quality UIs. Use when building or modifying user-facing interfaces. Use when creating components, implementing layouts, managing state, or when the output needs to look and feel production-quality rather than AI-generated. Spanish triggers: "construye esta interfaz", "crea este componente", "implementa la UI".
---
